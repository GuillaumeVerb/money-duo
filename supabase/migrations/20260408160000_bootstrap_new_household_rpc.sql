-- Création de foyer depuis l’app : une seule RPC en SECURITY DEFINER pour éviter les
-- refus RLS / JWT ambigus sur PostgREST (insert households + membres + catégories + invite).
