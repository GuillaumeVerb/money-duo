-- Dashboard → SQL : crée / met à jour la RPC « Créer ton foyer » (param _default_split_rule en text pour PostgREST).
-- À exécuter une fois. Ensuite : Dashboard → Project Settings → API → « Reload schema » si l’erreur « schema cache » persiste 1–2 min.
